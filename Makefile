...
.PHONY: all build clean install uninstall simplify check run e2e-tests e2e-tests-faults e2e-tests-matrix e2e-tests-scale unit-tests integration-tests unit-tests-docker integration-tests-docker e2e-tests-etcd
